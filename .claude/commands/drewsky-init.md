...
- **Chain of Verification** (Meta AI): 4-step fact-checking reducing hallucinations by 23%
- **Dual-Loop Planning** (Microsoft): Strategic + tactical coordination with stall detection
- **Reflective Learning** (Stanford/SambaNova): Experience extraction and pattern recognition
...
2. **Verify Framework Installation**
   - Check that docs, scripts, and output directories exist
   - Confirm core documentation is accessible
   - Validate framework structure

3. **Activate Enhanced Modes**
   - **Structured Thinking**: Apply TCREI to every task
   - **Systematic Decomposition**: Use MAKER for complexity
   - **Fact Verification**: Apply CoVe when making claims
   - **Strategic Planning**: Use dual-loop for large work
   - **Transparency**: Always separate facts from assumptions

4. **Report Activation Status**
   - Confirm which methodologies are active
   - Summarize enhanced capabilities
...
- Dual-loop planning → maintained direction → successful delivery

## Available Commands After Init

- `/tcrei` - Structure any request with TCREI
